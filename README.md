...
- [**skytrail**](https://github.com/alsantosrafael/skytrail): A cloud-native orchestration platform that allows Directed Acyclic Graphs (DAGs) scheduling and/or execution of tasks (Java)
